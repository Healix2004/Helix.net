...
namespace Helix.Infrastructure.Migrations
{
    ...
    [Migration("20260710115815_add lab specdialist table ")]
    partial class addlabspecdialisttable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Helix.Data.Entities.Appointment", b =>
                {
                    ...
                    b.Property<string>("PatientInstruction")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Helix.Data.Entities.Doctor", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("AvailabeDays")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("SpecialtyCatalogCode");
            ...
            modelBuilder.Entity("Helix.Data.Entities.LabOrder", b =>
                {
                    ...
                    b.Property<Guid>("MedicalConceptId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Helix.Data.Entities.LabSpecialist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("LabSpecialistLicenseUrl")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Helix.Data.Entities.Pharmacy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PrimaryLicenseUrl")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Helix.Data.Entities.PrescriptionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Helix.Data.Entities.RadiologyReport", b =>
                {
                    ...
                    b.Property<string>("DicomStudyInstanceUid")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ExternalRadiologistName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Helix.Data.Entities.SpecialtyCatalog", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Helix.Data.Entities.LabOrder", b =>
                {
                    ...
                    b.HasOne("Helix.Data.Entities.MedicalConcept", "MedicalConcept")
                        .WithMany()
                        .HasForeignKey("MedicalConceptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Helix.Data.Entities.LabTestResult", b =>
                {
                    ...
                    b.HasOne("Helix.Data.Entities.LabOrder", "LabOrder")
                        .WithMany("Results")
            ...
            modelBuilder.Entity("Helix.Data.Entities.RadiologyReport", b =>
                {
                    b.HasOne("Helix.Data.Entities.RadiologyOrder", "RadiologyOrder")
                        .WithOne("Report")
                        .HasForeignKey("Helix.Data.Entities.RadiologyReport", "RadiologyOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
